...
function HomePage() {
  ...
  return (
    <HomeContainer>
      ...
      >
        <AuthorizedComponent permissions={[PERMISSION.MODELS_VIEW]}>
          <Col span={12}>
            <Link prefetch href={"/models?page=0&size=20&type=OPEN"}>
              <HomeNavigateCards hoverable>
                ...
                <ModelDetails>
                  ...
                  <CardDescription>
                    Find the ideal open source model and deploy it to start
            ...
            <Link prefetch href={"/models?page=0&size=20&type=CLOSED"}>
              <HomeNavigateCards hoverable>
                ...
                <ModelDetails>
                  ...
                  <CardDescription>
                    Access models from OpenAI, Cohere, Google by entering your
                    API key for seamless application integration.
                  </CardDescription>
                </ModelDetails>
              </HomeNavigateCards>
            </Link>
        ...
        <AuthorizedComponent permissions={[PERMISSION.KNOWLEDGEBASE_VIEW]}>
          <Col span={12}>
            <Link prefetch href={"/knowledge-base"}>
              <HomeNavigateCards hoverable>
                ...
                <ModelDetails>
                  ...
                  <CardDescription>
                    Transform text into vectors for RAG-enhanced applications,
                    by uploading your data or connecting platforms like
                    Confluence.
                  </CardDescription>
                </ModelDetails>
              </HomeNavigateCards>
        ...
        <AuthorizedComponent permissions={[PERMISSION.WORKFLOWS_VIEW]}>
          <Col span={12}>
