      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            />
            <ModelTitle>TinyLlama/TinyLlama-1.1B-Chat-v1.0</ModelTitle>
          ...
          <ModelAbout>
            ...
            trillion tokens. With some proper optimization, we can achieve this
            within a span of "just" 90 days using
          </ModelAbout>
          <Row gutter={[0, 10]}>
            <Tag>sdkhbcskdj</Tag>
            <Tag>sdkjnksjdnc</Tag>
            <Tag>jnkjndvkdfns</Tag>
            <Tag>sdkhbcskdj</Tag>
            <Tag>sdkhbcskdj</Tag>
          </Row>
        </Col>
